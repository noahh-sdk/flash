...
:rocket: Decently fast (~30s to build docs for [Noahh](https://github.com/noahh-sdk/noahh))
...
The docs for [Noahh](https://github.com/noahh-sdk/noahh) have been built with Flash: <https://docs.noahh-sdk.org>.
